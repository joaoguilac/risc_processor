...
{
    sc_in<sc_uint<32>> InstructionIn, DataOut1In, DataOut2In;
    sc_in<sc_uint<32>> AddrMemLoadFonteIn, AddrUlaRegIn, AddrMemLoadRegIn, AddrMemWriteIn;
    sc_in<bool> UlaOPIn, CtrlMemWriteIn, JumpIn, RegWriteIn, MemLoadIn, JumpCmpIn, JumpNegIn;
    sc_in_clk clock;

    sc_out<sc_uint<32>> InstructionOut, DataOut1, DataOut2;
